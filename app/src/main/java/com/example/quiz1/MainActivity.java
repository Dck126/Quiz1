...
public class MainActivity extends AppCompatActivity {
    ...
    public void moveMaps(View view) {
        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/maps/w2j8tEpuoMqMMGFh8")).setPackage("com.google.android.apps.maps"));
    }

    public void moveSms(View view) {
        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("sms:" + "085240348592")).putExtra("sms_body", "Hai nama saya Dicky"));
    }
